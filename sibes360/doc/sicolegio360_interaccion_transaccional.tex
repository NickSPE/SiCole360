...
\subsection{Dashboard Power BI 5: Proyección Financiera Anual e Ingreso Recurrente (ARR Educativo)}
Visualización tipo \textit{Waterfall Chart} y proyección temporal que analiza la cascada de ingresos por pensiones de marzo a diciembre y el flujo de caja estimado.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{3.png}
    \caption{Power BI Dashboard 5: Proyección Financiera Anual e Ingreso Recurrente (ARR Educativo)}
    \label{fig:powerbi_arr_proyeccion}
\end{figure}

\begin{cajaConcepto}[Toma de Decisiones Estratégicas -- Power BI Dashboard 5 (Planificación Financiera)]
\textbf{Decisiones Estratégicas Habilitadas:}
\begin{enumerate}
    \item \textbf{Aprobación del Plan de Inversión Anual:} Determina el techo presupuestal para equipamiento de laboratorios, mejoras en infraestructura física y aumentos salariales docentes basados en el $\text{ARR}$ confirmado.
    \item \textbf{Gestión de Línea de Crédito Preventiva:} Anticipa meses de baja liquidez para programar financiamientos bancarios de corto plazo antes del vencimiento de compromisos laborales.
\end{enumerate}
\end{cajaConcepto}

\subsection{Dashboard Power BI 6: Panel de Fidelización y Retención Estudiantil (Análisis de Churn)}
Visualización de cohortes y gráfico de dona que analiza las tasas de retención de alumnado ($\text{TRA}$), traslados y motivos de retiro institucional.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{3.png}
    \caption{Power BI Dashboard 6: Panel de Fidelización y Retención Estudiantil (Análisis de Churn)}
    \label{fig:powerbi_retencion_churn}
\end{figure}

\begin{cajaConcepto}[Toma de Decisiones Estratégicas -- Power BI Dashboard 6 (Directorio / Promotora)]
\textbf{Decisiones Estratégicas Habilitadas:}
\begin{enumerate}
    \item \textbf{Corrección de Causas de Retiro Estudiantil:} Permite intervenir sobre factores de insatisfacción pedagógica o problemas económicos antes de la pérdida definitiva de matrícula.
    \item \textbf{Programa de Fidelización de Familias Antiguas:} Diseña descuentos de continuidad para familias con más de dos hijos matriculados o con más de 5 años en la institución.
\end{enumerate}
\end{cajaConcepto}
...
De esta manera, cuando el Director del "Colegio San José" abre el reporte de Power BI, el motor analít\section{Plan de Mejora Continua y Eficiencia Operativa}
